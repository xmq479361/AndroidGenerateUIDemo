...
//public class XBindProcessor extends AbstractProcessor {
//    @Override
...
//    }
//
//    private JavaFile generateBindEvent( TypeElement typeElement) {
...
//            bindViewMethodSpecBuilder.addStatement(String.format("activity.%s = (%s)activity.findViewById(%d);",
